            ...
            if (!error)
            {
                ...
                else
                {
                    ...
                    if (!modificar)
                    {
                        ...
                        String lunes = ORM.HorariInstalacioORM.insertHorariInstalacio(1, idHoras[0], id_instalacion);

                        //Añadir HORARIO_INSTALACION martes
                        String martes = ORM.HorariInstalacioORM.insertHorariInstalacio(2, idHoras[1], id_instalacion);

                        //Añadir HORARIO_INSTALACION miercoles
                        String miercoles = ORM.HorariInstalacioORM.insertHorariInstalacio(3, idHoras[2], id_instalacion);

                        //Añadir HORARIO_INSTALACION jueves
                        String jueves = ORM.HorariInstalacioORM.insertHorariInstalacio(4, idHoras[3], id_instalacion);

                        //Añadir HORARIO_INSTALACION viernes
                        String viernes = ORM.HorariInstalacioORM.insertHorariInstalacio(5, idHoras[4], id_instalacion);

                        //Añadir HORARIO_INSTALACION sabado
                        String sabado = ORM.HorariInstalacioORM.insertHorariInstalacio(6, idHoras[5], id_instalacion);

                        //Añadir HORARIO_INSTALACION domingo
                        String domingo = ORM.HorariInstalacioORM.insertHorariInstalacio(7, idHoras[6], id_instalacion);
                    ...
                    else
                    {
                        ...
                        String lunes = ORM.HorariInstalacioORM.modificarHorariInstalacio(1, ids[0], idHoras[0], _instalacio.id);

                        //Modificar HORARIO_INSTALACION martes
                        String martes = ORM.HorariInstalacioORM.modificarHorariInstalacio(2, ids[1], idHoras[1], _instalacio.id);

                        //Modificar HORARIO_INSTALACION miercoles
                        String miercoles = ORM.HorariInstalacioORM.modificarHorariInstalacio(3, ids[2], idHoras[2], _instalacio.id);

                        //Modificar HORARIO_INSTALACION jueves
                        String jueves = ORM.HorariInstalacioORM.modificarHorariInstalacio(4, ids[3], idHoras[3], _instalacio.id);

                        //Modificar HORARIO_INSTALACION viernes
                        String viernes = ORM.HorariInstalacioORM.modificarHorariInstalacio(5, ids[4], idHoras[4], _instalacio.id);

                        //Modificar HORARIO_INSTALACION sabado
                        String sabado = ORM.HorariInstalacioORM.modificarHorariInstalacio(6, ids[5], idHoras[5], _instalacio.id);

                        //Modificar HORARIO_INSTALACION domingo
                        String domingo = ORM.HorariInstalacioORM.modificarHorariInstalacio(7, ids[6], idHoras[6], _instalacio.id);
